...
export const W04_PT: Record<string, string> = {
  ...
  "w04.cockpit.title": "OPERAÇÃO AGORA",
  "w04.cockpit.nextAction": "PRÓXIMA AÇÃO",
  "w04.cockpit.noStep": "Nenhuma etapa em andamento",
  "w04.cockpit.noStepBody": "Inicie a próxima etapa para colocar a operação em movimento.",
  "w04.cockpit.noAction": "Nada pendente nesta etapa no momento.",
  "w04.cockpit.delay": "Atraso acumulado:",
  "w04.cockpit.tone.ready": "Pronto",
  "w04.cockpit.tone.blocked": "Bloqueado",
  "w04.cockpit.tone.attention": "Atenção",
  "w04.cockpit.tone.late": "Atrasado",
  "w04.cockpit.action.resolvePeople": "Resolver pendências de pessoas",
  "w04.cockpit.action.confirmBoarding": "Confirmar embarque dos passageiros",
  "w04.cockpit.action.completeOperation": "Concluir a operação",
  "w04.cockpit.reason.peoplePending": "Há pessoas sem conferência nesta etapa.",
  "w04.cockpit.reason.notReady": "A etapa ainda não está pronta segundo o servidor.",
  "w04.cockpit.reason.arrivalMissing": "Registre a chegada antes de concluir esta etapa.",
  "w04.cockpit.summary.present": "Presentes",
  "w04.cockpit.summary.boarded": "Embarcados",
  "w04.cockpit.summary.pending": "Pendentes",
  "w04.cockpit.summary.absent": "Ausentes",
};
...
export const W04_EN: Record<string, string> = {
  ...
  "w04.cockpit.title": "OPERATION NOW",
  "w04.cockpit.nextAction": "NEXT ACTION",
  "w04.cockpit.noStep": "No step running",
  "w04.cockpit.noStepBody": "Start the next step to put the operation in motion.",
  "w04.cockpit.noAction": "Nothing pending on this step right now.",
  "w04.cockpit.delay": "Accumulated delay:",
  "w04.cockpit.tone.ready": "Ready",
  "w04.cockpit.tone.blocked": "Blocked",
  "w04.cockpit.tone.attention": "Attention",
  "w04.cockpit.tone.late": "Late",
  "w04.cockpit.action.resolvePeople": "Resolve pending people",
  "w04.cockpit.action.confirmBoarding": "Confirm passenger boarding",
  "w04.cockpit.action.completeOperation": "Complete the operation",
  "w04.cockpit.reason.peoplePending": "Some people are still unaccounted for on this step.",
  "w04.cockpit.reason.notReady": "The server does not consider this step ready yet.",
  "w04.cockpit.reason.arrivalMissing": "Record arrival before completing this step.",
  "w04.cockpit.summary.present": "Present",
  "w04.cockpit.summary.boarded": "Boarded",
  "w04.cockpit.summary.pending": "Pending",
  "w04.cockpit.summary.absent": "Absent",
};
