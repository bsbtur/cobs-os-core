...
/** Only tenant operators manage the checklist; operational roles grant nothing. */
...
/**
 * Planning stays editable in draft/planning. During an active operation the
 * checklist may also be corrected through the audited playbook RPCs; runtime
 * execution facts remain separate and are never rewritten. `ready` preserves
 * the frozen pre-start baseline, and terminal operations remain read-only.
 */
