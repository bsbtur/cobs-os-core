...
/**
 * The deployed W11 database uses the canonical runtime event names VISITED,
 * IGNORED, UNAVAILABLE and RESTORED, while the original V1 client derivation
 * still understands VISIT_POINT_COMPLETED / VISIT_POINT_SKIPPED / STARTED.
