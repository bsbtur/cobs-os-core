...
import { ArrowRight, CheckCircle2, Crown, GraduationCap, HeartHandshake, Hotel, Loader2, MapPin, Plane, ShieldCheck, Sparkles, Users, UtensilsCrossed } from "lucide-react";
...
export const Route = createFileRoute("/ciosp-2027")({
  head: () => ({ meta: [
    ...
    { name: "description", content: "CIOSP 2027 com curadoria BSBTUR: viagem, hospedagem, mobilidade e suporte em uma experiência premium de Brasília para São Paulo." },
  ]}),
...
const gallery = [
  ...
  ["https://images.unsplash.com/photo-1436491865332-7a61a109cc05?auto=format&fit=crop&w=1200&q=88", "Sua jornada começa antes do congresso", "Logística organizada para você chegar com tranquilidade."],
