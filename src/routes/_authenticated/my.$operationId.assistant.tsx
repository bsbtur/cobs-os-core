...
export const Route = createFileRoute("/_authenticated/my/$operationId/assistant")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Tire dúvidas sobre a sua viagem usando apenas informações confirmadas da operação." },
              ...
              <div key={message.messageId} className={mine ? "flex justify-end" : "flex justify-start"}>
                ...
                >
                  <div className="mb-1 flex items-center gap-2 text-xs opacity-80">
                    {mine ? <UserRound className="size-3.5" aria-hidden="true" /> : <Bot className="size-3.5" aria-hidden="true" />}
