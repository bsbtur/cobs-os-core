    ...
    <section className="space-y-4">
      ...
      >
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Acompanhe a cobertura editorial das etapas que realmente pedem conteúdo
              interpretativo.
            </p>
        ...
        <div className="mt-3 space-y-1 text-xs text-muted-foreground">
          ...
          <p>
            {completeInterpretiveStepCount}/{interpretiveSteps.length} etapas editorialmente
            relevantes estão completas
            {editorialGapCount > 0 ? ` · ${editorialGapCount} ainda pedem enriquecimento` : ""}.
          </p>
          <p>
            Deslocamentos, embarques, desembarques, retornos e pausas não contam como lacunas
            interpretativas obrigatórias.
          </p>
        </div>
      </section>
