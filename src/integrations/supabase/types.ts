...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      journey_blueprint_steps: {
        Row: {
          ...
          presence_requirement: Database["public"]["Enums"]["step_presence_requirement"] | null;
          sequence: number;
      ...
      message_audience_selectors: {
        Row: {
          ...
          id: string;
          message_id: string;
          participation_kind: Database["public"]["Enums"]["participation_kind"] | null;
          person_id: string | null;
    ...
    Enums: {
      ...
      commercial_reservation_status: "reserved" | "confirmed" | "released" | "expired";
      communication_channel: "in_app";
      communication_event_type: "MESSAGE_PUBLISHED" | "IN_APP_DELIVERY_CREATED" | "MESSAGE_READ";
      delivery_status: "delivered";
      event_lifecycle_status: "draft" | "planning" | "program_locked" | "ready" | "closed_out";
      ...
      hospitality_stay_status: "draft" | "confirmed" | "active" | "completed" | "cancelled";
      ...
      operation_status: "draft" | "planning" | "ready" | "active" | "completed" | "cancelled";
      order_status: "draft" | "submitted" | "confirmed" | "cancelled" | "completed";
      ...
      transport_leg_kind: "outbound" | "transfer" | "shuttle" | "return" | "other";
      transport_vehicle_kind: "bus" | "minibus" | "van" | "car" | "boat" | "shuttle" | "other";
...
export const Constants = {
  public: {
    Enums: {
      ...
      payment_method: ["cash", "bank_transfer", "other"],
      payment_order_status: ["open", "partially_paid", "paid", "overdue", "cancelled", "refunded"],
      playbook_execution_action: ["completed", "reopened"],
      playbook_item_kind: ["check", "confirm", "brief", "verify", "other"],
      playbook_requirement: ["required", "recommended", "informational"],
      presence_fact: [
