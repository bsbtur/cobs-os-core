...
begin
  ...
  -- Health is intentionally conservative: only real, actionable conditions
  -- may elevate the state. Draft/planning gaps are not runtime incidents,
  -- and completed/cancelled operations do not remain in an active warning state.
