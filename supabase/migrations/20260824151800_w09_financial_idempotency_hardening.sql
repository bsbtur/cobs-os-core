-- COBS OS W09 financial hardening
-- Requires a non-empty bounded idempotency key for payment, refund and reversal facts.
-- Keeps the public RPC signatures stable while preventing duplicate financial mutations on retries.
