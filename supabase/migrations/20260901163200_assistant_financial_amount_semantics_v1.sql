...
begin
  ...
  return jsonb_build_object(
    'currency',_currency,
    'amount_unit','major',
    'amount_semantics','All monetary amount fields are expressed in major currency units. For BRL, 2490.00 means R$ 2.490,00. Do not divide or multiply these values.',
    'order_total',round(coalesce(_order_total,0)::numeric/100,2),
    'paid_total',round(_paid_total::numeric/100,2),
    'refunded_total',round(_refunded_total::numeric/100,2),
    'net_paid',round(_net_paid::numeric/100,2),
    'balance_due',round(_balance::numeric/100,2),
