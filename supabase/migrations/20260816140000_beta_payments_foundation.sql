-- BETA-03 Payments Foundation
-- Provider-agnostic financial layer. Mercado Pago is the first adapter.
...
create table public.payment_charges (
  ...
  status public.payment_charge_status not null default 'draft',
...
create table public.payment_events (
  id uuid primary key default gen_random_uuid(),
  tenant_id uuid not null references public.tenants(id) on delete cascade,
  charge_id uuid references public.payment_charges(id) on delete cascade,
