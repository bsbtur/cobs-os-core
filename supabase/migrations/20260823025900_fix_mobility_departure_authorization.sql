...
begin
  ...
  -- A leg is commonly linked to the movement step, while the canonical departure
  -- authorization is recorded on the immediately preceding boarding/return step.
  -- Accept either the linked step's own authorization or, for a movement step,
  -- the authorization on that immediate departure gate. Do not search farther back.
