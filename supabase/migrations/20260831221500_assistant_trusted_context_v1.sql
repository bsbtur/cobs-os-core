-- Assistant Trusted Context V1
-- Server-side context enrichment only. The browser cannot provide trusted facts.
...
begin
  ...
  where j.tenant_id=_tenant_id and j.operation_id=_operation_id and j.traveler_facing is true and j.archived_at is null;
