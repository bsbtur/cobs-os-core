-- AUD correction: invitation acceptance reactivates an existing membership
-- without changing its assigned role. Role changes remain governed by the
-- membership authorization path and guard_membership_change().
